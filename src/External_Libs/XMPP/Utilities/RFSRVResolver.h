...
#define DEBUG_DNS_SRV YES   // Prints data as it comes out of SRV DNS resolver

#define DDLogDns_Srv(format, ...)     do{ if(DEBUG_DNS_SRV)      NSLog((format), ##__VA_ARGS__); }while(0)

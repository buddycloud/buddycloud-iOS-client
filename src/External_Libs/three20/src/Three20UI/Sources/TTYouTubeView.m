...
static CGFloat kDefaultWidth = 230;
static CGFloat kDefaultHeight = 150;
...
<body style=\"background:#0A364A;margin-top:0px;margin-left:0px\">\
<div><object width=\"%0.0f\" height=\"%0.0f\">\
<param name=\"movie\" value=\"%@\"></param><param name=\"wmode\"\
value=\"transparent\"></param><param name=\"quality\" value=\"high\"></param>\
